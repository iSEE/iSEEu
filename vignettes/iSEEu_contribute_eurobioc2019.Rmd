...
> 
> In an attempt to simplify this procedure for commonly used setups, we implemented a few different `iSEE` "modes" (https://github.com/iSEE/iSEE/blob/master/R/modes.R), each of which defines a set of panels and content for the resulting application.
> 
